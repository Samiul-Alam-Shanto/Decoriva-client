      ...
      {open && (
        ...
        >
          ...
          <div className="text-sm space-y-1 mb-3">
            ...
            <CopyItem label="Email" value="admin@gmail.com" />
          ...
          <div className="text-sm space-y-1">
            <p className="font-medium text-gray-600">Decorator</p>
            <CopyItem label="Email" value="decorator@gmail.com" />
            <CopyItem label="Password" value="123456Aa!" />
          </div>
          <hr className="my-2" />
          ...
          <div className="text-sm space-y-1">
            ...
            <CopyItem label="Email" value="user@gmail.com" />
            <CopyItem label="Password" value="123456Aa!" />
          </div>
        </div>
      )}
